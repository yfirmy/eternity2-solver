...
E2Clue1-dfs: $(CLUE1_DFS_OBJ) $(COMMON_DFS_OBJ)
	g++ -v -o bin/$@ $^

E2Puzzle-dfs: $(PUZZLE_DFS_OBJ) $(COMMON_DFS_OBJ)
	g++ -v -o bin/$@ $^

E2ControlSample-dfs: $(CONTROLSAMPLE_DFS_OBJ) $(COMMON_DFS_OBJ)
	g++ -v -o bin/$@ $^

# Breadth First Search applications

E2Clue1-bfs: $(CLUE1_BFS_OBJ) $(COMMON_BFS_OBJ)
	g++ -v -o bin/$@ $^

E2Puzzle-bfs: $(PUZZLE_BFS_OBJ) $(COMMON_BFS_OBJ)
	g++ -v -o bin/$@ $^

E2ControlSample-bfs: $(CONTROLSAMPLE_BFS_OBJ) $(COMMON_BFS_OBJ)
	g++ -v -o bin/$@ $^

# Main (DFS)

obj/E2Clue1_dfs.o: src/E2Applications/E2Clue1Solver/E2Clue1.cpp
	g++ -DDEPTH_FIRST_SEARCH -DCLUE1 $(CFLAGS) -o $@ -c $^

obj/E2Puzzle_dfs.o: src/E2Applications/E2PuzzleSolver/E2Puzzle.cpp
	g++ -DDEPTH_FIRST_SEARCH -DPUZZLE $(CFLAGS) -o $@ -c $^

obj/E2ControlSample_dfs.o: src/E2Applications/E2ControlSampleSolver/E2ControlSample.cpp
	g++ -DDEPTH_FIRST_SEARCH -DSAMPLE $(CFLAGS) -o $@ -c $^
	
# Main (BFS)

obj/E2Clue1_bfs.o: src/E2Applications/E2Clue1Solver/E2Clue1.cpp
	g++ -DBREADTH_FIRST_SEARCH -DCLUE1 $(CFLAGS) -o $@ -c $^

obj/E2Puzzle_bfs.o: src/E2Applications/E2PuzzleSolver/E2Puzzle.cpp
	g++ -DBREADTH_FIRST_SEARCH -DPUZZLE $(CFLAGS) -o $@ -c $^

obj/E2ControlSample_bfs.o: src/E2Applications/E2ControlSampleSolver/E2ControlSample.cpp
